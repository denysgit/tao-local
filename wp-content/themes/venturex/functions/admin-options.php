...
$options = array (
				...
				array(	"name" => __('Slider Type', 'templatesquare'),
											"desc" => __('Select slider type that you would like to have displayed in the slideshow section on your homepage.', 'templatesquare'),
				...
				array( 	"name" => __('Slider Timeout', 'templatesquare'),
											"desc" => __('Please enter number for slider timeout(transition time). Default is 6000', 'templatesquare'),
