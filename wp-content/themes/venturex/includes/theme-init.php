...
function ts_setup() {
	...
	if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
		...
		add_image_size( 'slider-post-thumbnail', 920, 280, true ); // Slider Thumbnail
		add_image_size( 'portfolio-post-thumbnail', 286, 166, true ); // Portfolio Thumbnail
		add_image_size( 'portfolio2-post-thumbnail', 266, 166, true ); // Portfolio2 Thumbnail
	}
